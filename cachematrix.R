#This function gets a matrix as an input, sets the value of the matrix, gets the value of the matrix, sets the inverse Matrix and gets the inverse Matrix. The matrix object can cache its #own object. 
...
# In case inverse matrix from makeCacheMatrix((matrix) has some value in it (always works after running the code 1st time), it returns a message  "Getting Cached Invertible Matrix" 
